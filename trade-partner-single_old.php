...
<div class="pg_banner avo_shps_banner">
    <div class="container">
        ...
        <div class="avo_sopcnt">
            ...
            <div class="avp_sopbtn trd_prt">
                <a class="back-button" href="https://avocomm.avocadosfrommexico.com/trademonthlyreport.php">BACK</a>
...
<div class="shopper_partner_sec trd_prt_sec">
    <div class="container">
        ...
        if ( $vendor ) {
          ...
          if ( $conn->num_rows() > 0 ) {
        ?>
        <div class="avo_support_docu <?php echo $conn->num_rows();?>">
                      ...
                      if ( $conn->num_rows() > 0 ) {
                          ...
                          while ( $doc = $conn->fetch( $docs ) ) {
                              ...
                              if ( $doc['documen_type_id'] ==1 || $doc['documen_type_id']==2 ) {
                                  ...
                                  echo '
                            <div class="avo_shpsdoc '.$ext.'">
                                <div class="avo_shpsdou_img">
                                    <a href="javascript:void(0)" data-id="' . $doc['id'] . '"><img src="/timThumb.php?src=/assets/documentation_images/' . $image . '&w=181&h=130&zc=1" alt="avo_dou_img"></a>
                                    ';
                                ...
                                <div class="avo_shpsdou_cnt">';
                                    ...
                                    echo '<h4><a href="/assets/documentation_images/' . $doc['image'] . '" download>' . stripslashes( $doc['title'] ) . '</a></h4>';
                                    }else {
                                        $image_name = $doc['document'];
                                        $folder_name = 'documentation_docs';
                                    echo '<h4><a href="/assets/documentation_docs/' . $doc['document'] . '" download>' . stripslashes( $doc['title'] ) . '</a></h4>';
                                    }


                                    echo '<p>' . $doc['description'] . '</p>
                                    
                                    <img src="/assets/icons/ico_' . $ext . '.png" alt="' . strtoupper( $ext ) . '" width="36" height="48"><a href="/assets/'.$folder_name.'/' . $image_name . '" download>DOWNLOAD</a>
                                </div>';
                                ...
                                <div class="container">
                                    <div class="vdo_popup">
                                        <div class="pop_hdr">
                                            ...
                                            <div class="download">
                                                <a href="/assets/'.$folder_name.'/' . $image_name . '" download>Download</a>
                                            </div>
                                            <div class="close">
