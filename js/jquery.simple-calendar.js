...
//            header.find('.month').html(this.settings.months[date.getMonth()]);
            header.find('.month').html(this.settings.months[date.getMonth()]+' <span class="notranslate"> '+date.getFullYear()+' </span>');
        },
        ...
        buildCalendar: function (fromDate, calendar) {
            ...
            var body = $('<table class="notranslate"></table>');
            ...
            tbody.on('click', '.day', function (e) {
                ...
                const selectedDateEN = [month, day, year].join('/');
                const selectedDateES = [day, month, year].join('/');
                ...
                if ($(e.currentTarget).hasClass('event')) {
                    ...
                    if(jQuery('.srch_dt_ml .ml .en').hasClass('active')) {
                        console.log(selectedDateEN);
                        $(plugin.element).find('.event-container>.event-date').text(selectedDateEN);
                    } else {
                        console.log(selectedDateES);
                        $(plugin.element).find('.event-container>.event-date').text(selectedDateES);
                    }
