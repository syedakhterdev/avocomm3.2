...
if ($id) {
    ...
    if (!$msg && $token != '' && $token == $_POST['upd_token']) {
        if (!$FSDocumentation->update($_POST['update'], $sid, $_SESSION['admin_period_id'], $_POST['title'], $_POST['description'], $_POST['image'], $_POST['document'], $_POST['document_type_id'], $_POST['active'])) {
            ...
            if ( $_POST['old_document'] != $_POST['document'] && ( $_POST['document'] != '' || $_POST['image'] == '' ) ) { // if the document has changed, and it's an image, and no preview image was specified
              ...
              if ( (int)$_POST['document_type_id'] == 1 && in_array( $ext, array( 'jpg', 'jpeg', 'png', 'gif' ) ) ) { // if the document type is an image create a thumbnail
                $ShopperDocumentation->makeThumbnail( $update, $_SERVER['DOCUMENT_ROOT'] . "/assets/fs_documentation_docs/", $document, $_SERVER['DOCUMENT_ROOT'] . "/assets/fs_documentation/" );
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Edit A Foodservice Documentation</strong></li>
                    </ol>
                                        ...
                                        <td>
                                            <div class="col-sm-12">
                                                <select name="document_type_id" id="document_type_id" class="form-control" required>
                                                    ...
                                                    <?php echo $FSDocumentation->getDocument_types_Document_typeDropdown(( $msg ) ? $_POST['document_type_id'] : $row['document_type_id'] ); ?>
                                                </select>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                  ...
                                                  ?>
                                                  <a href="/assets/fs_documentation_docs/<?php echo $row['document']; ?>" download><img
                                ...
                                <?php if ($row['image'] != '') { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <img src="/manager/timThumb.php?src=/assets/fs_documentation/<?php echo $row['image']; ?>&w=200&h=80" style="border: 1px solid #CCCCCC;padding: 2px;margin: 4px;">
                                                    <br>
