        ...
        <div class="container-fluid" id="main">
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <div class="row my-4 mgr_body vendor vendor_documentation program_edit">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <form action="add.php?sid=<?php echo $vid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <!--<div class="form-group row">
                                    <label for="documen_type_id" class="col-sm-4 col-form-label">Document Type <span class="required_sign">*</span></label>
                                    <div class="col-sm-8">
                                        <select name="documen_type_id" id="documen_type_id" class="form-control" required>
                                            <option value="">Select an option...</option>
                                <?php // echo $VendorDocumentation->getDocument_types_Document_typeDropdown(( $msg ) ? $_POST['documen_type_id'] : 0 ); ?>
