...
if ( $del_id ) {
	...
	if ( $token != '' && $_POST['token'] == $token ) {
		if ( !$FSProgramUpdate->delete( $del_id ) ) {
        ...
        <div class="col main pt-5 mt-3">
            ...
            <div class="col-lg-10">
              <h3 class="float-left"><?php echo SECTION_TITLE; ?></h3>
					...
					<ol class="breadcrumb bc-3">
						...
						<li>&nbsp;/&nbsp;</li>
						<li><strong>Foodservice Program Updates</strong></li>
					</ol>
          ...
          <div class="row my-4 mgr_body">
            <div class="col-lg-10 col-md-8">
							...
							$rowsPerPage = 15;
							$total_count = $FSProgramUpdate->getFS_Program_UpdatesCount();
							...
							<div class="table-responsive">
								...
								<tbody>
								<?php
								$result = $FSProgramUpdate->getFS_Program_Updates( $conn->offset, $rowsPerPage );

								if ( $conn->num_rows() > 0 ) {
									while( $row = $conn->fetch($result) ) {
										echo '
									<tr>
										<td>' . $conn->parseOutputString( $row['fs_program_id'] ) . '</td>
									...
									echo "<td colspan=\"6\">No FS program updates found.</td>";
								}
								?>
								</tbody>
							</table>
