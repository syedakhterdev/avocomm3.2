...
if ($del_id) {
    ...
    if ($token != '' && $_POST['token'] == $token) {
        if (!$ShopperDocumentation->delete($del_id)) {
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Shopper Documentations</strong></li>
                    </ol>
                    ...
                    <div class="row my-4 mgr_body">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <?php
                            //$sql = "SELECT COUNT(*) FROM shopper_documentation WHERE id > 0;";
                            $rowsPerPage = 15;
                            $total_count = $ShopperDocumentation->getShopper_DocumentationsCount();
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $ShopperDocumentation->getShopper_Documentations($conn->offset, $rowsPerPage);
                                        ...
                                        if ($conn->num_rows() > 0) {
                                            while ($row = $conn->fetch($result)) {
                                                echo '
                                                        <tr>
                                                            <td>
                                                                ' . ( ( $row['image'] ) ? "<img src=\"/manager/timThumb.php?src=/assets/shopper_documentation/" . $row['image'] . "&h=60&zc=1\" class=\"listing_image\">" : '' ) . '
                                            ...
                                            echo "<td colspan=\"5\">No shopper documentations found.</td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
