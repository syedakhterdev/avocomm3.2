            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Add a Shopper Partner</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body shopper program_edit partner_add">
                            ...
                            <form action="add.php?sid=<?php echo $sid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <button type="button" id="cancel" name="cancel" class="btn action_btn cancel float-right" onClick="window.location.href = '<?php echo $sid ? '../shopper_programs/edit.php?sid=' . $sid : 'index.php'; ?>';">Cancel</button>
                                    </div>
                                </div>
