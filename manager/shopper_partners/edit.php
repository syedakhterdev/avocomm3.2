            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><a href="/manager/shopper_partners/">Shopper Partners</a></li>
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Edit a <?php echo ENTITY; ?></strong></li>
                    </ol>

                    <div class="row my-4 mgr_body shopper program_edit partner_edit">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <form action="edit.php" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <?php if ($row['logo'] != '') { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <img src="/manager/timThumb.php?src=/assets/shopper_partners/<?php echo $row['logo']; ?>&w=200&h=80" style="border: 1px solid #CCCCCC;padding: 2px;margin: 4px;">
                                                    <br>
                                                    <a href="edit.php?id=<?php echo $id; ?>&del_logo=1" style="width: 206px;margin: 4px;" class="btn action_btn cancel">Remove Logo</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                <?php } else { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="logo" name="logo" placeholder="Click to upload" onfocus="this.blur();" onclick="window.open('../includes/tinymce/plugins/filemanager/dialog.php?type=1&fldr=shopper_partners&field_id=logo&popup=1', '<?php echo time(); ?>', 'width=900,height=550,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;" >
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn action_btn float-right save" style="min-width: 130px;">Update</button>
                                        <button type="button" id="cancel" name="cancel" class="btn action_btn cancel float-right" onClick="window.location.href = 'index.php';" style="min-width: 130px;">Cancel</button>
                                    </div>
                                </div>
