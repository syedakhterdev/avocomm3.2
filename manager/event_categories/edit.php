            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Edit an Event Category</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body program_edit event_category event_category_edit">
                            ...
                            <form action="edit.php" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <table style="width: 100%;" class="add_edit">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="category" name="category" onKeyUp="updateCountdown('#category', 65, '#category_lbl');" placeholder="" required onKeyDown="updateCountdown('#category', 65, '#category_lbl');" value="<?php echo ( $msg ) ? $_POST['category'] : $row['category']; ?>" maxlength="65">
