            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    <div class="row mgr_heading">
                        <div class="col-lg-10">
                            <h3 class="float-left">Non Approved Users</h3>
                        </div>
                    </div>
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Non Approved Users</strong></li>
                    </ol>
                                            ...
                                            while ($row = $conn->fetch($result)) {
                                                echo '
                                                        <tr>
                                                            ...
                                                            <td align = "center" class="listing_icons" >
                                                            <a href = "index.php?resend=' . $row['id'] . '&page=' . $page . '" title = "Resend Welcome Email" class="action_btn resend_email">WC Email <i class="fa fa-repeat" aria-hidden = "true" ></i >
                                                            </a >
                                                            </td >
                                                        </tr>';
                                            }
