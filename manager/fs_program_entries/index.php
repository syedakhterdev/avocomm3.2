...
if ($del_id) {
    ...
    if ($token != '' && $_POST['token'] == $token) {
        if (!$FSProgram->deleteUpdate($_SESSION['admin_period_id'], $del_id)) {
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    <div class="row mgr_heading">
                        <div class="col-lg-10">
                            <h3 class="float-left">Manage Foodservice Entries</h3>
                        </div>
                    </div>
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Foodservice Entries</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body program_edit program_entries foodservice">
                        <div class="col-lg-10 col-md-8">
                            ...
                            $rowsPerPage = 15;
                            $total_count = $FSProgram->getFS_ProgramsCountCurrent($_SESSION['admin_period_id']);
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $FSProgram->getFS_ProgramsCurrent($_SESSION['admin_period_id'], $conn->offset, $rowsPerPage);
                                        ...
                                        if ($conn->num_rows() > 0) {
                                            while ($row = $conn->fetch($result)) {
                                                echo '
                                                        <tr>
                                                            <td>' . ( ( $row['image'] ) ? "
                                                                <img src=\"/manager/timThumb.php?src=/assets/fs_programs/" . $row['image'] . "&h=60&zc=1\" class=\"listing_image\">" : '' ) . '
                                            ...
                                            echo "<td colspan=\"3\">No food service programs found.</td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
