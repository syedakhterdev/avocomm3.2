            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Add News</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body news program_edit news_add">
                            ...
                            <form action="add.php" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <table style="width: 100%;" class="add_edit">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="url" name="url" onKeyUp="updateCountdown('#url', 255, '#url_lbl');" placeholder="" required onKeyDown="updateCountdown('#url', 255, '#url_lbl');" value="<?php echo ( $msg ) ? $_POST['url'] : ''; ?>" maxlength="255" onChange="getURLContents(this.value);">
