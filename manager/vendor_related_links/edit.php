...
if ($id) {
    ...
    if (!$msg && $token != '' && $token == $_POST['upd_token']) {
        if (!$VendorRelatedLink->update($_POST['update'], $_SESSION['admin_period_id'], $vid, $_POST['title'], $_POST['description'], $_POST['image'], $_POST['url'], $_POST['sort'])) {
        ...
        <div class="container-fluid" id="main">
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <div class="row my-4 mgr_body vendor vendor_related_link_edit program_edit">
                        <div class="col-lg-10 col-md-8">

                            <form action="edit.php?vid=<?php echo $vid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <?php if ($row['image'] != '') { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <img src="/manager/timThumb.php?src=/assets/vendor_related_links/<?php echo $row['image']; ?>&w=200&h=80" style="border: 1px solid #CCCCCC;padding: 2px;margin: 4px;">
                                                    <br>
                                                    <a href="edit.php?id=<?php echo $id; ?>&vid=<?php echo $vid; ?>&del_image=1">Remove Image</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                <?php } else { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="image" name="image" placeholder="Click to upload" onfocus="this.blur();" onclick="window.open('../includes/tinymce/plugins/filemanager/dialog.php?type=1&fldr=vendor_related_links&field_id=image&popup=1', '<?php echo time(); ?>', 'width=900,height=550,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
                                                                return false;" >
                                                </div>
                                        ...
                                        <td>
                                            <div class="col-sm-12">
                                                <select name="sort" id="sort" class="form-control" required>
                                                    ...
                                                    <?php echo $VendorRelatedLink->getRangeDropDown(1, 20, ( $msg ) ? $_POST['sort'] : $row['sort'] ); ?>
                                                </select>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <button type="button" id="cancel" name="cancel" class="btn action_btn cancel float-right" style="width: auto;" onClick="window.location.href = '<?php echo $vid ? '../trade_vendor_entries/edit.php?id=' . $vid : 'index.php'; ?>';">Cancel</button>
                                    </div>
                                </div>
