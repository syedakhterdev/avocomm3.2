        ...
        <div class="container-fluid" id="main">
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <div class="row my-4 mgr_body vendor vendor_related_link_add program_edit">
                        <div class="col-lg-10 col-md-8">

                            <form action="add.php?vid=<?php echo $vid; ?>" role="form" method="POST" onSubmit="return validateForm();">
