                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <div class="row my-4 mgr_body users index">
                        <div class="col-lg-10 col-md-8">
                            ...
                            $rowsPerPage = 15;
                            $total_count = $User->getUsersCount();
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="add_button">
                                    <a href="export.php"><button type="button" style="margin-left: 5px" class="btn btn-primary btn-sm float-right">Export Users</button></a>
                                    ...
                                    <a href="/manager/approved_users"><button type="button" class="btn btn-primary btn-sm">Approved Users</button></a>
                                ...
                                <table class="table table-striped table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $User->getUsers($conn->offset, $rowsPerPage);
                                            ...
                                            while ($row = $conn->fetch($result)) {
                                                echo '
                                                        <tr>
                                                            ...
                                                            if($row['set_password']!='') {
                                                                echo '<td align = "center" class="listing_icons" ><a href = "index.php?resend=' . $row['id'] . '&page=' . $page . '" title = "Resend Welcome Email" class="action_btn resend_email">WC Email <i class="fa fa-repeat" aria-hidden = "true" ></i ></a ></td >';
                                                                }else{
                                                                echo '<td align = "center" class="listing_icons" >&nbsp;</td>';
                                                            }
                                                        echo '</tr>';
                                            }
                                        } else {
