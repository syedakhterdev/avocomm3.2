...
if ($insert) {
    ...
    if (!$msg) {
        if ($token != '' && $token == $_POST['add_token']) {
            if (!$id = $ShopperProgramBin->add($sid, $_POST['title'], $_POST['image'], $_POST['sort'], $_POST['active'])) {
                $msg = "Sorry, an error has occurred, please contact your administrator.<br>Error: " . $ShopperProgramBin->error() . ";";
            } else {
                if ($sid)
                    header("Location: ../shopper_programs/edit.php?add=1&id=$sid");
                else
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Add A Shopper Program Bin</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body shopper program_edit program_bin_add">
                            ...
                            <form action="add.php?sid=<?php echo $sid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <table style="width: 100%;" class="add_edit">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="image" name="image" placeholder="Click to upload" onfocus="this.blur();" onclick="window.open('../includes/tinymce/plugins/filemanager/dialog.php?type=1&fldr=shopper_program_bins&field_id=image&popup=1', '<?php echo time(); ?>', 'width=900,height=550,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;" >
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td>
                                            <div class="col-sm-12">
                                                <select name="sort" id="sort" class="form-control" required>
                                                    ...
                                                    <?php echo $ShopperProgramBin->getRangeDropDown(1, 20, ( $msg ) ? $_POST['sort'] : 0 ); ?>
                                                </select>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <button type="button" id="cancel" name="cancel" class="btn action_btn cancel float-right" onClick="window.location.href = '<?php echo $sid ? '../shopper_programs/edit.php?id=' . $sid : 'index.php'; ?>';">Cancel</button>
                                    </div>
                                </div>
