            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Edit a Shopper Program Update</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body program_edit program_updates_edit shopper">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <form action="edit.php?sid=<?php echo $sid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn action_btn float-right save">Save</button>
