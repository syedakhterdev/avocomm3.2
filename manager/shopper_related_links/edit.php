...
if ($id) {
    ...
    if (!$msg && $token != '' && $token == $_POST['upd_token']) {
        if (!$ShopperRelatedLink->update($_POST['update'], $_SESSION['admin_period_id'], $sid, $_POST['title'], $_POST['description'], $_POST['image'], $_POST['url'], $_POST['sort'])) {
...
<?php require( '../includes/header_new.php' );?>
    ...
    <div class="latest_activities hd-grid activity_log">
        <div class="container">
            <div class="heading_sec">
                <h2><bold>Edit A</bold> SHOPPER RELATED LINK</h2>
            </div>
    ...
    <div class="main-form">
        <div class="container">
            ...
            <form action="<?php echo ADMIN_URL?>/shopper_related_links/edit.php?sid=<?php echo $sid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                ...
                <div class="form-group text-box">
                    ...
                    <input type="url" id="url" name="url" onKeyUp="updateCountdown('#url', 250, '#url_lbl');" placeholder=""  onKeyDown="updateCountdown('#url', 250, '#url_lbl');" value="<?php echo ( $msg ) ? $_POST['url'] : $row['url']; ?>" maxlength="250" onChange="getURLContents( this.value );">
                ...
                <?php if ($row['image'] != '') { ?>
                    ...
                    <div class="form-group text-box">
                        ...
                        <div class="col-sm-12">
                            <img src="<?php echo ADMIN_URL?>/timThumb.php?src=/assets/shopper_related_links/<?php echo $row['image']; ?>&w=200&h=80" style="border: 1px solid #CCCCCC;padding: 2px;margin: 4px;">
                            <br>
                            <a href="<?php echo ADMIN_URL?>/shopper_related_links/edit.php?id=<?php echo $id; ?>&sid=<?php echo $sid; ?>&del_image=1" class="btn action_btn cancel">Remove Image</a>
                        </div>
                ...
                <div class="form-group text-box">
                    ...
                    <select name="sort" id="sort" required>
                        ...
                        <?php echo $ShopperRelatedLink->getRangeDropDown(1, 20, ( $msg ) ? $_POST['sort'] : $row['sort'] ); ?>
                    </select>
                </div>
                ...
                <button type="button" id="cancel" name="cancel" onClick="window.location.href = '<?php echo $sid ? ''.ADMIN_URL.'/shopper_program_entries/edit.php?id=' . $sid : 'index.php'; ?>';">
