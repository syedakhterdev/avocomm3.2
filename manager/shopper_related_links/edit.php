            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Edit a Shopper Related Link</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body shopper program_edit documentation_edit">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <form action="edit.php?sid=<?php echo $sid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <?php if ($row['image'] != '') { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <img src="/manager/timThumb.php?src=/assets/shopper_related_links/<?php echo $row['image']; ?>&w=200&h=80" style="border: 1px solid #CCCCCC;padding: 2px;margin: 4px;">
                                                    <br>
                                ...
                                <?php } else { ?>
                                    <table style="width: 100%;" class="add_edit">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="image" name="image" placeholder="Click to upload" onfocus="this.blur();" onclick="window.open('../includes/tinymce/plugins/filemanager/dialog.php?type=1&fldr=shopper_related_links&field_id=image&popup=1', '<?php echo time(); ?>', 'width=900,height=550,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0'); return false;" >
                                                </div>
                                                <script>
                                ...
                                <!--<div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="url" class="form-control" id="url" name="url" onKeyUp="updateCountdown('#url', 250, '#url_lbl');" placeholder=""  onKeyDown="updateCountdown('#url', 250, '#url_lbl');" value="<?php echo ( $msg ) ? $_POST['url'] : $row['url']; ?>" maxlength="250">
                                        <span id="url_lbl" class="small"></span>
                                    </div>
                                </div>-->
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <button type="button" id="cancel" name="cancel" class="btn action_btn cancel float-right" onClick="window.location.href = '<?php echo $sid ? '../shopper_program_entries/edit.php?id=' . $sid : 'index.php'; ?>';">Cancel</button>
                                    </div>
                                </div>
