            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Add a Shopper Related Link</strong></li>
                    </ol>

                    <div class="row my-4 mgr_body shopper program_edit Related_link_add">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <form action="add.php?sid=<?php echo $sid; ?>" role="form" method="POST" onSubmit="return validateForm();">
                                ...
                                <!--<div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="url" class="form-control" id="url" name="url" onKeyUp="updateCountdown('#url', 250, '#url_lbl');" placeholder=""  onKeyDown="updateCountdown('#url', 250, '#url_lbl');" value="<?php echo ( $msg ) ? $_POST['url'] : ''; ?>" maxlength="250">
                                        <span id="url_lbl" class="small"></span>
                                    </div>
                                </div>-->
