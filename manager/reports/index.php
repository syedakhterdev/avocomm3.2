...
<?php include( '../includes/nav.php' ); ?>
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <div class="row my-4 mgr_body reports index">
                                    ...
                                    <tbody>
                                        ...
                                        if ($conn->num_rows() > 0) {
                                            while ($row = $conn->fetch($result)) {
                                                echo '
                                                        <tr>
                                                            <td>' . ( ( $row['image'] ) ? "<img src=\"/manager/timThumb.php?src=/assets/reports/" . $row['image'] . "&w=120&h=60&zc=1\"class=\"listing_image\">" : '' ) . '<a href="edit.php?id=' . $row['id'] . '">' . $conn->parseOutputString($row['title']) . '</a></td>
                                                            <td align="center" style="text-align: center;">' . $row['sort'] . '</td>
                                            ...
                                            echo "<td colspan=\"8\">No reports found.</td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
