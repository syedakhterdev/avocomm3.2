            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col main pt-5 mt-3">
                    ...
                    <ol class="breadcrumb bc-3">
                        ...
                        <li>&nbsp;/&nbsp;</li>
                        <li><strong>Vendor Updates</strong></li>
                    </ol>
                    ...
                    <div class="row my-4 mgr_body vendors index">
                        <div class="col-lg-10 col-md-8">
                            ...
                            <?php
                            //$sql = "SELECT COUNT(*) FROM vendor_updates WHERE id > 0;";
                            $rowsPerPage = 15;
                            $total_count = $VendorUpdate->getVendor_UpdatesCount();
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-sm">
                                    <thead class="thead-inverse">
                                        <tr>
                                            <th>Vendor Id</th>
                                            <th style="text-align: center;width: 12%;">Period Id</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $VendorUpdate->getVendor_Updates($conn->offset, $rowsPerPage);

                                        if ($conn->num_rows() > 0) {
                                            while ($row = $conn->fetch($result)) {
                                                echo '
                                                        <tr>
                                                            <td><a href="edit.php?id=' . $row['id'] . '">' . $conn->parseOutputString($row['vendor_id']) . '</a></td>
                                                            <td align="center">' . $conn->parseOutputString($row['period_id']) . '</td>
                                            ...
                                            echo "<td colspan=\"4\">No vendor updates found.</td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
