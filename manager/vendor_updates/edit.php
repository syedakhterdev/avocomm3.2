...
<div class="latest_activities hd-grid activity_log">
    <div class="container">
        <div class="heading_sec">
            <h2><bold>Edit A</bold> VENDOR UPDATE</h2>
        </div>
        <div class="add-new-entry-sec">
            <button type="button" id="cancel" name="cancel" class="btn btn-primary back-btn" onclick="window.location.href = '<?php echo ADMIN_URL?>/trade_vendor_entries/index.php';">
...
<div class="main-form">
    <div class="container">
        ...
        <form action="<?php echo ADMIN_URL?>/vendor_updates/edit.php?sid=<?php echo $vid; ?>" role="form" method="POST" onSubmit="return validateForm();">
            ...
            <div class="form-group text-box">
                ...
                <textarea id="current_marketing_activities" name="current_marketing_activities" rows="8"><?php echo ( $msg ) ? $_POST['current_marketing_activities'] : $row['current_marketing_activities']; ?></textarea>
            </div>

            <div class="form-group text-box">
                <label for="html">Upcoming Marketing Activities</label><br>
                <textarea id="upcoming_marketing_activities" name="upcoming_marketing_activities" rows="8"><?php echo ( $msg ) ? $_POST['upcoming_marketing_activities'] : $row['upcoming_marketing_activities']; ?></textarea>
            </div>

            <div class="form-group text-box">
                <label for="html">Current Shopper Marketing Activities</label><br>
                <textarea id="current_shopper_marketing_activities" name="current_shopper_marketing_activities" rows="8"><?php echo ( $msg ) ? $_POST['current_shopper_marketing_activities'] : $row['current_shopper_marketing_activities']; ?></textarea>
            </div>

            <div class="form-group text-box">
                <label for="html">Upcoming Shopper Marketing Activities</label><br>
                <textarea id="upcoming_shopper_marketing_activiites" name="upcoming_shopper_marketing_activiites" rows="8"><?php echo ( $msg ) ? $_POST['upcoming_shopper_marketing_activiites'] : $row['upcoming_shopper_marketing_activiites']; ?></textarea>
            </div>
            ...
            <button type="button" id="cancel" name="cancel" onClick="window.location.href = '<?php echo ADMIN_URL?>/trade_vendor_entries/index.php';">
